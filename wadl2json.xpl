...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
    ...
    <!-- 
        run like this: 
        java -Xmx1024m -jar /home/dcramer/applications/xmlcalabash-1.0.13-94/calabash.jar -i "source=../RAX-AUTH.wadl"  ~/rax/wadl-tools-dwcramer/wadl2json.xpl 
        
        TODO: param format=path-format
    -->
